...
class ReservaVuelo private constructor(id : String, fechaCreacion: String, descripcion: String,val origen : String, val destino : String, val horaVuelo : String) : Reserva(id,fechaCreacion,descripcion){
    ...
    companion object{
        fun crearInstancia(descripcion : String, origen : String, destino : String, horaVuelo : String) = ReservaVuelo(id = generarId() , fechaCreacion = generarFecha(),descripcion, origen, destino, horaVuelo)
    }
